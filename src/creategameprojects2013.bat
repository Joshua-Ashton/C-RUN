devtools\bin\vpc.exe /deferred +game /mksln Game_Deferred-2013.sln /2013
devtools\bin\vpc.exe /template +game /mksln Game_Template-2013.sln /2013
devtools\bin\vpc.exe /portal +game /mksln Game_Portal-2013.sln /2013
