...
devtools\bin\vpc.exe /hl2 +game /mksln Game_HL2-2012.sln /2012
devtools\bin\vpc.exe /hl2_template +game /mksln Game_HL2_Template-2012.sln /2012
devtools\bin\vpc.exe /crun +game /mksln Game_CRUN-2013.sln /2012